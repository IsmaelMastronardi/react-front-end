...
** Hello World front end** is a React app that fetches greetings from an api.
...
## 👥 Backedn Link <a name="backend-link"></a>

- [Backend](https://github.com/IsmaelMastronardi/rails-api-hello)
